...
export default function FlightLayout() {
  return (
    <>
      ...
      <div className="] text-[18px] max-w-[600px] pl-10 py-8 text-white text-left">
        <h3>
          Airlines save a number of <span>$7,084</span> discounted seats for every
          flight <span></span> called "consolidator" fares.{" "}
        </h3>
        <h3>Now they're yours. <span></span></h3>
